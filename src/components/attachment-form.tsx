...
export function AttachmentForm() {
  ...
  const form = useForm<AttachmentFormData>({
    ...
    defaultValues: {
      ...
      nomeEntidadeAcolhimento: "",
      moradaEntidadeAcolhimento: "",
      codigoPostalEntidadeAcolhimento: "",
      telefoneEntidadeAcolhimento: "",
      emailEntidadeAcolhimento: "",
      pessoaContactadaEntidadeAcolhimento: "",
      cargoPessoaContactadaEntidadeAcolhimento: "",
      supervisorEntidadeAcolhimento: "",
  ...
  async function onSubmit(data: AttachmentFormData) {
    try {
      ...
      if (newAttachment?.id) {
        setTimeout(() => {
          navigate(`/attachments/${newAttachment.id}`);
        }, 1500);
      }
    } catch (error) {
              ...
              <>
                ...
                {shouldShowPropostaFields && (
                  <>
                    ...
                    {/* Campos adicionais quando temLocalEstagio é "sim" */}
                    {form.watch("temLocalEstagio") === "sim" && (
                      <>
                        <FormField
                          control={form.control}
                          name="nomeEntidadeAcolhimento"
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-base font-semibold">
                                8.(EA1) Nome da entidade de acolhimento
                              </FormLabel>
                              <FormControl>
                                <Input
                                  placeholder="Introduza a sua resposta"
                        ...
                        <FormField
                          control={form.control}
                          name="moradaEntidadeAcolhimento"
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-base font-semibold">
                                9.(EA1) Morada da entidade de acolhimento
                              </FormLabel>
                              <FormControl>
                                <Input
                                  placeholder="Morada, Código postal, Localidade"
                                  {...field}
                                  disabled={createLoading}
                                />
                              </FormControl>
                        ...
                        <FormField
                          control={form.control}
                          name="codigoPostalEntidadeAcolhimento"
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-base font-semibold">
                                10.(EA1) Código postal da entidade de
                                acolhimento
                              </FormLabel>
                              <FormControl>
                                <Input
                        ...
                        <FormField
                          control={form.control}
                          name="telefoneEntidadeAcolhimento"
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-base font-semibold">
                                11.(EA1) Telefone da entidade de acolhimento
                              </FormLabel>
                              <FormControl>
                                <Input
                                  type="tel"
                        ...
                        <FormField
                          control={form.control}
                          name="emailEntidadeAcolhimento"
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-base font-semibold">
                                12.(EA1) Email da entidade de acolhimento
                              </FormLabel>
                              <FormControl>
                                <Input
                                  type="email"
                        ...
                        <FormField
                          control={form.control}
                          name="pessoaContactadaEntidadeAcolhimento"
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-base font-semibold">
                                13.(EA1) Pessoa contactada na entidade de
                                acolhimento
                              </FormLabel>
                              <FormControl>
                                <Input
                        ...
                        <FormField
                          control={form.control}
                          name="cargoPessoaContactadaEntidadeAcolhimento"
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-base font-semibold">
                                14.(EA1) Cargo da pessoa contactada na entidade
                                de acolhimento
                              </FormLabel>
                              <FormControl>
                                <Input
                        ...
                        <FormField
                          control={form.control}
                          name="supervisorEntidadeAcolhimento"
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-base font-semibold">
                                15.(EA1) Supervisor na entidade de acolhimento
                              </FormLabel>
                              <FormControl>
                                <Input
                                  placeholder="Introduza a sua resposta"
                        ...
                        <FormField
                          control={form.control}
                          name="emailSupervisorEntidadeAcolhimento"
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-base font-semibold">
                                16.(EA1) Email do supervisor na entidade de
                                acolhimento
                              </FormLabel>
                              <FormControl>
                                <Input
                        ...
                        <FormField
                          control={form.control}
                          name="cargoSupervisorEntidadeAcolhimento"
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-base font-semibold">
                                17.(EA1) Cargo do supervisor na entidade de
                                acolhimento
                              </FormLabel>
                              <FormControl>
                                <Input
