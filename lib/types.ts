...
export const documentTypeLabels: Record<DocumentType, string> = {
  ...
  "requerimento-ucs-atraso": "Requerimento a Estágio com UCs em Atraso (Art. 14)",
  "plano-estagio": "Plano de Estágio (Anexo III)",
  "ata-reuniao-orientador-estagiario": "Ata de Reunião Orientador e Estagiário (Anexo IV)",
  "ata-reuniao-orientador-supervisor-estagiario": "Ata de Reunião Orientador, Supervisor e Estagiário (Anexo V)",
  ...
  "requerimento-adiamento-relatorio": "Requerimento de Adiamento de Entrega do Relatório de Estágio (Anexo X)",
